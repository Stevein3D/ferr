...
#Hello everyone, my name is Steve and I am very new to Ruby
puts 'Welcome to the Secret Number Game!'

first_name = "Steve"
last_name = "Sikoryak"

puts 'Created by ' + first_name + "" + last_name + 'on March 30th 2013'

#This is my first interaction with Ruby.  So far so good, though it seems too simple
#to be true.
